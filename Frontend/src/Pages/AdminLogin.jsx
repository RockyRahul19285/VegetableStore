...
export const AdminLogin=()=>{
    ...
    const onToast = (s) => {
      ...
      const handleLogin = async (e) => {
        e.preventDefault();
        const res = await fetch(`http://localhost:8080/admin/adminLogin/${user.email}/${user.password}`, {
          method: "POST",
        });
        ...
        if (isNaN(responseText)) {
          ...
          SetLocalStorage("AdminId", responseText); // Store Admin ID in localStorage
